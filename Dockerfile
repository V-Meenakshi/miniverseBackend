...
# We use a full JDK image to compile the Java code and build the JAR file.
...
# We use a smaller JRE image which is all that's needed to run the application.
...
# Spring Boot will automatically read the environment variables.
